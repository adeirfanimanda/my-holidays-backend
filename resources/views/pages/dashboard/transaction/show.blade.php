        ...
        <script>
            ...
            var datatable = $('#crudTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'tours.name', name: 'tours.name' },
                    { data: 'tours.price', name: 'tours.price' },
                    ...
                    <table class="table-auto w-full">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border px-6 py-4">{{ $transaction->choose_date }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="border px-6 py-4 text-right">Fee</th>
                                <td class="border px-6 py-4">{{ number_format($transaction->fee) }}</td>
                            </tr>
                            <tr>
